...
process sample_probs {
    ...
    """
  probs=\$( modkit sample-probs --reference ${ref}  -p 0.1 --interval-size 5000000 --only-mapped --threads ${task.cpus} ${xam} 2> /dev/null | awk 'NR>1 {ORS=" "; print "--filter-threshold "\$1":"\$3}' )
"""
}
